<template>
  <form name="degustation" method="POST" netlify action="/merci" class="w-full max-w-md center">
        ...
        <div class="relative">
          ...
          >
            <option
              ...
              v-bind:value="whiskyTypeOption"
              v-bind:key="whiskyTypeOption.id"
        ...
        <div class="relative">
          ...
          >
            <option
              ...
              v-bind:value="whiskyOriginOption"
              v-bind:key="whiskyOriginOption.id"
